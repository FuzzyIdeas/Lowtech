...
public final class EonilFSEventStream {
     ...
     */
    public init(pathsToWatch: [String], sinceWhen: EonilFSEventsEventID, latency: TimeInterval, flags: EonilFSEventsCreateFlags, handler: @escaping (EonilFSEventsEvent) -> Void) throws {
...
//    FSEventsCopyUUIDForDevice(dev_t dev)                          __macOS_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_6_0);
...
//    FSEventsGetLastEventIdForDeviceBeforeTime(
//    dev_t            dev,
//    CFAbsoluteTime   time)                                      __macOS_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_6_0);
...
//    FSEventsPurgeEventsForDeviceUpToEventId(
//    dev_t                  dev,
//    FSEventStreamEventId   eventId)                             __macOS_AVAILABLE_STARTING(__MAC_10_5, __IPHONE_6_0);
...
public extension EonilFSEventStream {
    ...
    @available(macOS, deprecated: 13.0, message: "Use setDispatchQueue instead")
     ...
     */
    @available(macOS 10.5, *)
    @available(macOS, deprecated: 13.0, message: "Use invalidate instead")
